                       ...
                       <header>
                        ...
                        <div class="content-inner">
                            <div class="form-wrapper">
                                ...
                                <form name="editProduct" action="updateAdmin" onsubmit=""  method="post"  enctype="multipart/form-data">
                                
                                    <div class="form-group">
                                        <label class="sr-only">Title</label>
                                        <input type="hidden" name="id" value="<%=resultSet.getString("adminId") %>">
										<input type="text" class="form-control" name="id" id="id" value="<%=resultSet.getString("adminId") %>" placeholder="Id">
                                    </div>
                                    
                                       <div class="form-group">
                                        <label class="sr-only">Name</label>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<%=resultSet.getString("Email") %>">
                                    </div>
                                     ...
                                     <!-- - --div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="em" id="em" placeholder="Email" value="<%=resultSet.getString("Email")%>">
                                    </div>
                                    
                                       <div class="form-group">
                                        <label class="sr-only">Qty</label>
                                        <input type="text" class="form-control" name="pw" id="pw" placeholder="Password" value="<%=resultSet.getString("Password") %>">
                                    </div>
