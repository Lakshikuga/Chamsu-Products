                          ...
                          <div class="row">
                            ...
                            <div id="content">
                               <header class="clearfix">
                                   <h2 class="page-title pull-left">All Products</h2>
                                   <button type="button" class="btn btn-xs btn-primary pull-right" onclick="location.href='AddProduct.jsp'">Add Product</button>
                               </header> 
...
try{ 
	...
	String sql ="SELECT ProId, ProName, Category, Price, Qty, filename FROM products";
    ...
    <a class="btn btn-xs btn-default" href="deletePro.jsp" role="button">
    <span class="glyphicon glyphicon-remove" aria-hidden="true">&nbsp;Delete</span>
    </a></td>
    
    <td><a href="update1.jsp?id=<%=rs.getString("ProId")%>">update</a></td>                                        
	</tr>
