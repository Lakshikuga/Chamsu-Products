                              ...
                              <li class="link">
                               ...
                               <!--  --li class="link">
                                  ...
                                  <ul class="collapse collapseable" id="collapse-post">
                                      <li><a href="Logo.jsp">Logo Management</a></li>
                                  </ul>
                              </li----->
                          ...
                          <div class="row">
                            ...
                            <div id="content">
                               <header class="clearfix">
                                   <h2 class="page-title pull-left">All Merchants</h2>
...
try{ 
	...
	String sql ="SELECT * FROM seller2";
    ...
    <td><a href="payment.jsp?id=<%=rs.getString("SellerId")%>">Buy</a></td>                                         
	</tr>
