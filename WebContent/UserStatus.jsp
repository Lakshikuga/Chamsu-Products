                          ...
                          <div class="row">
                            ...
                            <div id="content">
                               <header class="clearfix">
                                   <h2 class="page-title pull-left">All Customers</h2>
...
try{ 
	...
	String sql ="SELECT * FROM login order by uId";
	...
	while(rs.next()){
		i=i%2;
		i++;
		queryStringuser="select * from user where UserId="+rs.getInt(4);
		rs1 = stm1.executeQuery(queryStringuser);
		while(rs1.next())
		  {
		  user  = rs1.getString(4);
		  }
		 String inStr="";
		 String outStr="";
		 java.util.Date date;
		 ...
		 if((rs.getString(2)!=null && rs.getString(2)!=""))
		  {
		  inStr = rs.getString(2).toString().substring(0,rs.getString(2).toString().indexOf("."));
		  try {
		 ...
		 if((rs.getString(3)!=null && rs.getString(3)!=""))
		  {
		  outStr = rs.getString(3).toString().substring(0,rs.getString(4).toString().indexOf("."));
		  try{
