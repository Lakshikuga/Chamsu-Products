...
%>
    ...
    <table class="aaa" cellpadding="20" cellspacing="2">
        <tr><p><font size="6" style="color: white; font-border: 3px solid black; ">customer details</font></p></tr>
			
        	<tr>
        	<th>Name</th>&emsp;&emsp;&emsp;
        	<th>Home Number</th>&emsp;&emsp;&emsp;
        	<th>Mobile Number </th>&emsp;&emsp;&emsp;
        	<th>Address</th>&emsp;&emsp;&emsp;
        	<th>city</th>&emsp;&emsp;&emsp;
			<th>Postal</th>&emsp;&emsp;&emsp;
...
try{ 
	...
	<td><%=resultSet.getString("postal") %></td>
	<td><%=resultSet.getString("email") %></td>
	

	<!-- - --td><a href="deletecustomer.jsp?id=<%=resultSet.getString("id") %>"><button>Delete</button></a></td---->
    <td><a href="deletecustomer.jsp?id=<%=resultSet.getString("id") %>"><button>Delete</button></a> </td>
	</tr>
