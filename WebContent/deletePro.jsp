          ...
          <div class="row display-table-row">
              ...
              <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
                  ...
                  <div class="row">
                    ...
                    <div id="content">
                       <header>
                           <h2 class="page-title">Delete Products</h2>
                       </header> 
                            ...
                            <div class="form-wrapper">
                                <form action="deletePro" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="proid" placeholder="Product Id">
                                    </div>
                                    ...
                                    <div class="clearfix">
                                       ...
                                       <!-- - --div class="clearfix">
                                        <button type="submit" class="btn btn-primary pull-left" onclick="window.location.href='viewproducts.jsp'">View</button> 
                                    </div------->
